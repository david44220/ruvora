...
Canonical repo is david44220/ruvora. Feature work targets develop; neither pass is silently promoted into main. Pass 02 branch is feature/pass-02-attribution-events based on Pass 01 cbd762a, implementation 58482fb, delivered as draft PR 2 targeting develop. The initial GitHub Ubuntu run passed 239 unit, 68 PostgreSQL and 20 browser tests. A later creator-page flake prompted cross-runtime Prisma retry detection, read-first canonical shares and fail-on-flake CI; local coverage is now 258 unit and 72 PostgreSQL tests. See RELEASE_REPORT.md and PR checks for current evidence. Finalized economic history is preserved; use forward migrations only.
